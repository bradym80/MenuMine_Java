...
<!-- 
	...
	<webwork:iterator value="nationalAccountBenchmarkWebOptions.sectorSegmentChainRelations.incidenceSectors" status="mestatusSector">
		...
		function updateTarget()
		{
			...
			var chains = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.targetChains'];
			var sector = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.targetSectors'];
			var segment = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.targetSegments'];
		...
		*/
		...
		var chains = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.benchmarkChains'];
		var sector = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.benchmarkSectors'];
		var segment = document.forms['menuMineNABForm'].elements['nationalAccountBenchmarkWebOptions.benchmarkSegments'];
	...
	function openExcelNABCannedReport() {
