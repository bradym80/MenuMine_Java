...
<h3>Median Price Trend Options</h3>
<webwork:form theme="'simple'" method="'post'" action="'menumineMedianPriceTrend.action'" name="'menuMineMedianPrice'">
<table >
	<tr>
	...
	<tr>
		<td ><webwork:submit  theme="'simple'" name="'submitOptions'" value="'Redisplay Median Price Trend'" />	</td>
