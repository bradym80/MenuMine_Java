...
MENUMINE=~/Documents/workspace/menuminesvn
...
#mysqldump --opt --max_allowed_packet=64M -u root -ppassword -h menumine.fsrin.com menumine | mysql -u root -ppassword menumine >> /Users/crackintosh/Documents/workspace/menuminesvn/src/non-java/daily.log
...
#mysqldump --opt --max_allowed_packet=64M -u root -ppassword -h menumine.fsrin.com menumine_admin | mysql -u root -ppassword menumine_admin >> /Users/crackintosh/Documents/workspace/menuminesvn/src/non-java/daily.log
...
echo "download 07 from data entry machine" >> /Users/crackintosh/Documents/workspace/menuminesvn/src/non-java/daily.log
mysqldump -u root -ppassword -h 192.168.0.132 07 | mysql -u root -ppassword 07 >> /Users/crackintosh/Documents/workspace/menuminesvn/src/non-java/daily.log
...
#scp the databases back to menumine server, because mysqldump isnt working over network.
echo "scp the databases back to menumine server, because mysqldump isnt working over network." >> /Users/crackintosh/Documents/workspace/menuminesvn/src/non-java/daily.log
mysqldump -u root -ppassword --databases menumine menumine_admin > ~/menumine.sql
