...
/**
 * 2006-03-21 RSC Send the occassional message that tells us of interesting MM
 * events.
 * 
 * @author Reid
 * 
 */
public class MiscellaneousNotificationAlert {
    ...
    public void sendAlert(String information,
      ...
      //JDL 04-24-08 Changed recipient bug #34
        ...
        Message message = Message.factory.build("MenuMine Miscellaneous Alert", text
                .toString());
    ...
    protected static Log log = LogFactory
            .getLog(MiscellaneousNotificationAlert.class.getName());
