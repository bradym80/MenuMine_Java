 ...
 *  
 */
public class ViewItemsPerChainMenuingSectorGraphAction extends AbstractMenuMineSessionContextAwareAction {
...
//    private MenuMineSessionContextWrapper menuMineSessionContextWrapper;
    ...
    private void buildGraph() {
        ...
        chart = new ChartBuilder().buildItemsPerChainMenuingGraph(
