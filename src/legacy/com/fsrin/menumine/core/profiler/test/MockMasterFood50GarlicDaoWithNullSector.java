 ...
 *  
 */
public class MockMasterFood50GarlicDaoWithNullSector extends ProfileDao {

    private Collection data = new ArrayList();

    public MockMasterFood50GarlicDaoWithNullSector() {
        super();
        this.initData();
    }
