 ...
 *  
 */
public class MockMasterFood50GarlicDaoWithNullChainNames extends ProfileDao {

    private Collection data = new ArrayList();

    public MockMasterFood50GarlicDaoWithNullChainNames() {
        super();
        this.initData();
    }
    ...
    private void initData() {
        ...
        chain1.setSegment("Segment");
        chain1.setSectorName("Sector");
        chains[1] = chain1;

        Chain chain2 = new Chain();
        chain2.setOperationName(null);
