 ...
 *  
 */
public class HealthyProfileBeanCriteriaBuilder extends AbstractProfilerCriteriaBuilder {

    private String fields[] = { "healthyTerm", "healthyFlag", "healthySymbol" };
...
//    }
    ...
    public Class getProfileClass() {
        return HealthyProfileBean.class;
    }
