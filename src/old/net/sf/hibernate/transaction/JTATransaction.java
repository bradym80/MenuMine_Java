//$Id: JTATransaction.java,v 1.4 2005/08/24 04:33:25 nick Exp $
 ...
 * </tr>
 * <tr>
 * <td><tt>jta.UserTransaction</tt></td>
 * <td>JNDI name</td>
 * </tr>
 * </table>
 * 
...
public class JTATransaction implements Transaction {
    ...
    private void afterCommitRollback() throws TransactionException {
        ...
        if (!synchronization) { // this method is a noop if there is a
            // Synchronization!
            ...
            try {
                 ...
                 */
                session
                        .afterTransactionCompletion(status == Status.STATUS_COMMITTED);
            }
    ...
    public void begin(InitialContext context, String utName,
            TransactionManager transactionManager) throws HibernateException {
        ...
        if (newTransaction) {
            ...
            try {
                transactionManager.getTransaction().registerSynchronization(
                        new CacheSynchronization(session));
            } catch (Exception se) {
