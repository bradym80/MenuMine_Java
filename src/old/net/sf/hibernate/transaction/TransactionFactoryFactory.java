...
public final class TransactionFactoryFactory {
    ...
    private static final Log log = LogFactory
            .getLog(TransactionFactoryFactory.class);
     ...
     */
    public static TransactionFactory buildTransactionFactory(
            Properties transactionProps) throws HibernateException {

        String strategyClassName = transactionProps
        ...
        try {
            factory = (TransactionFactory) ReflectHelper.classForName(
            ...
            throw new HibernateException(
                    "Failed to instantiate TransactionFactory: " + e);
