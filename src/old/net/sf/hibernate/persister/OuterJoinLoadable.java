//$Id: OuterJoinLoadable.java,v 1.2 2005/04/03 06:29:05 nick Exp $
package net.sf.hibernate.persister;

import net.sf.hibernate.type.Type;

/**
 * A <tt>ClassPersister</tt> that may be loaded by outer join using the
 * <tt>OuterJoinLoader</tt> hierarchy and may be an element of a one-to-many
 * association.
 * 
...
public interface OuterJoinLoadable extends Loadable, Joinable {
    ...
    /**
     * Return the table name used to persist the numbered property of the class
     * or a subclass.
     */
    public String getSubclassPropertyTableName(int i);

    /**
     * Given the number of a property of a subclass, and a table alias, return
     * the aliased column names.
     */
