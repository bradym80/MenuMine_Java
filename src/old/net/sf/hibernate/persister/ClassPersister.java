//$Id: ClassPersister.java,v 1.3 2005/04/03 06:29:05 nick Exp $
...
/**
 * Concrete <tt>ClassPersister</tt> s implement mapping and persistence logic
 * for a particular persistent class. <br>
 * <br>
...
public interface ClassPersister {
    ...
    /**
     * Returns an object that identifies the space in which identifiers of this
     * class hierarchy are unique.
     * 
     ...
     * this class instance are persisted.
     */
     ...
     * will be cast to (optional operation).
     */
     ...
     * Or is it returned by the <tt>insert()</tt> method? This determines
     * which form of <tt>insert()</tt> will be called.
     */
    ...
    /**
     * Compare two snapshots of the state of an instance to determine if the
     * persistent state was modified
     * 
    ...
    /**
     * Get the "updateability" of the properties of this class (does the
     * property appear in an SQL UPDATE)
     */
    ...
    /**
     * Get the "insertability" of the properties of this class (does the
     * property appear in an SQL INSERT)
     */
    ...
    /**
     * Get the name of the identifier property (or return null) - need not
     * return the name of an actual Java property
     */
    ...
    /**
     * Get the current version of the object, or return null if there is no row
     * for the given identifier. In the case of unversioned data, return any
     * object if the row exists.
     */
