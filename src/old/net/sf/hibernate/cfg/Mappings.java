//$Id: Mappings.java,v 1.3 2005/04/03 06:29:05 nick Exp $
...
public class Mappings {
    ...
    Mappings(final Map classes, final Map collections, final Map tables,
            final Map queries, final Map sqlqueries, final Map imports,
            final Map caches, final List secondPasses,
            final List propertyReferences, final NamingStrategy namingStrategy) {
    ...
    public void addClass(PersistentClass persistentClass)
        ...
        Object old = classes.put(persistentClass.getMappedClass(),
                persistentClass);
        if (old != null)
            log.warn("duplicate class mapping: "
    ...
    public void addCollection(Collection collection) throws MappingException {
        ...
        if (old != null)
            log.warn("duplicate collection role: " + collection.getRole());
    }
