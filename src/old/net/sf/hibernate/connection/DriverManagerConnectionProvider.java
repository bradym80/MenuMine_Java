//$Id: DriverManagerConnectionProvider.java,v 1.3 2005/08/24 04:33:26 nick Exp $
...
public class DriverManagerConnectionProvider implements ConnectionProvider {
    ...
    public void configure(Properties props) throws HibernateException {
        ...
        poolSize = PropertiesHelper.getInt(Environment.POOL_SIZE, props, 20); //default
        // pool
        // size
        // 20
        log
        ...
        connectionProps = ConnectionProviderFactory
