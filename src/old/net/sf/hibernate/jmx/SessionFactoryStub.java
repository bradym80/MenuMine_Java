//$Id: SessionFactoryStub.java,v 1.3 2005/04/03 06:29:04 nick Exp $
...
/**
 * A flyweight for <tt>SessionFactory</tt>. If the MBean itself does not have
 * classpath to the persistent classes, then a stub will be registered with JNDI
 * and the actual <tt>SessionFactoryImpl</tt> built upon first access.
 * 
 * @author Gavin King
 */
public class SessionFactoryStub implements SessionFactory {
    ...
    SessionFactoryStub(HibernateService service) {
        ...
        SessionFactoryObjectFactory.addInstance(uuid, name, this, service
                .getProperties());
    }
        ...
        if (result == null) {
            ...
            if (result == null) {
                throw new InvalidObjectException(
                        "Could not find a stub SessionFactory named: " + name);
            } else {
    ...
    public Reference getReference() throws NamingException {
        return new Reference(SessionFactoryStub.class.getName(),
