//$Id: QueryableCollection.java,v 1.2 2005/04/03 06:29:04 nick Exp $
 ...
 * @author Gavin King
 */
public interface QueryableCollection extends PropertyMapping, Joinable,
        CollectionPersister {
    /**
    ...
    /**
     * Get the names of the collection index columnsm if this is an indexed
     ...
     * columns in the case of a one-to-many association)
     */
    ...
    /**
     * Get the persister of the element class, if this is a collection of
     * entities (optional operation). Note that for a one-to-many association,
     * the returned persister must be <tt>OuterJoinLoadable</tt>.
     */
