//$Id: SortedMap.java,v 1.3 2005/04/03 06:29:04 nick Exp $
...
public class SortedMap extends Map implements java.util.SortedMap {
    ...
    public SortedMap(SessionImplementor session, CollectionPersister persister,
            Comparator comparator, Serializable disassembled, Object owner)
            throws HibernateException {
        super(session);
     ...
     * super(session); this.map = new TreeMap(comp); }
     */
    ...
    public java.util.SortedMap subMap(Object fromKey, Object toKey) {
        read();
        java.util.SortedMap m = ((java.util.SortedMap) map).subMap(fromKey,
                toKey);
