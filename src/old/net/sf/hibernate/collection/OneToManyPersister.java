//$Id: OneToManyPersister.java,v 1.3 2005/08/24 04:33:26 nick Exp $
...
public class OneToManyPersister extends AbstractCollectionPersister {
    ...
    protected String generateDeleteString() {
        Update update = new Update().setTableName(qualifiedTableName)
                .addColumns(keyColumnNames, "null").setPrimaryKeyColumnNames(
                        keyColumnNames);
        if (hasIndex)
    ...
    /**
     * Generate the SQL UPDATE that updates a particular row's foreign key to
     * null
     */
        ...
        try {
            ...
            try {
                ...
                while (entries.hasNext()) {
                    ...
                    if (collection.needsUpdating(entry, i, elementType)) { // will
                        // still
                        // be
                        // issued
                        // when
                        ...
                        writeIndex(st, collection.getIndex(entry, i), false,
                                session);
    ...
    public String selectFragment(String alias, String suffix) {
        ...
        if (isOneToMany()) {
            ...
            buf.append(StringHelper.COMMA_SPACE).append(
                    ojl.selectFragment(alias, suffix));
        }
        return buf.toString();
    ...
    protected CollectionInitializer createCollectionInitializer(
        ...
        if (batchSize > 1) {
            ...
            Loader smallBatchLoader = new OneToManyLoader(this, smallBatchSize,
                    factory);
