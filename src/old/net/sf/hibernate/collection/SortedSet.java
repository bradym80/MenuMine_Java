//$Id: SortedSet.java,v 1.3 2005/04/03 06:29:04 nick Exp $
...
public class SortedSet extends Set implements java.util.SortedSet {
    ...
    public Comparator comparator() {
        return ((java.util.SortedSet) set).comparator();
    }
    ...
    public java.util.SortedSet tailSet(Object fromElement) {
        read();
        java.util.SortedSet s = ((java.util.SortedSet) set)
                .tailSet(fromElement);
        return new SubSetProxy(s);
    }
    ...
    class SubSetProxy extends SetProxy implements java.util.SortedSet {
        ...
        public java.util.SortedSet headSet(Object toValue) {
            return new SubSetProxy(((java.util.SortedSet) this.set)
                    .headSet(toValue));
        }
        ...
        public java.util.SortedSet subSet(Object fromValue, Object toValue) {
            return new SubSetProxy(((java.util.SortedSet) this.set).subSet(
                    fromValue, toValue));
        }
    ...
    public SortedSet(SessionImplementor session, CollectionPersister persister,
