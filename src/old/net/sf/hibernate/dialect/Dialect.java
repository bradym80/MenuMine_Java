//$Id: Dialect.java,v 1.3 2005/04/03 06:29:04 nick Exp $
 ...
 * <tt>register()</tt> a set of type mappings and default Hibernate
 * properties. <br>
 * <br>
...
public abstract class Dialect {
    ...
    /**
     * Does this dialect support <tt>FOR UPDATE OF</tt>, allowing particular
     * rows to be locked?
     */
    ...
    /**
     * Does this dialect support the Oracle-style <tt>FOR UPDATE NOWAIT</tt>
     * syntax?
     * 
     * @return boolean
     */
    ...
    public String getAddForeignKeyConstraintString(String constraintName,
        ...
        return new StringBuffer(30).append(" add constraint ").append(
                constraintName).append(" foreign key (").append(
    ...
    /**
     * The syntax that fetches the next value of a sequence, if sequences are
     * supported.
     * 
     * @param sequenceName
    ...
    public static Dialect getDialect() throws HibernateException {
        ...
        try {
            ...
            throw new HibernateException("Dialect class not found: "
                    + dialectName);
        } catch (Exception e) {
            throw new HibernateException("Could not instantiate dialect class",
                    e);
        }
    }
    ...
    /**
     * The seperator between the schema/tablespace name and the table name.
     */
