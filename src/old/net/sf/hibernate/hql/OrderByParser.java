//$Id: OrderByParser.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
public class OrderByParser implements Parser {
    ...
    // This uses a PathExpressionParser but notice that compound paths are not
    // valid,
    ...
    private final PathExpressionParser pathExpressionParser;
    {
        ...
        pathExpressionParser.setUseThetaStyleJoin(true); //TODO: would be nice
        // to use false, but
        // issues with MS SQL
    }
