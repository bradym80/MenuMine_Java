// $Id: JCASessionImpl.java,v 1.2 2005/04/03 06:29:05 nick Exp $
...
public class JCASessionImpl implements Session {
    ...
    /*
     * JCA 1.0 5.5.1 A connection implementation class implements its methods in
     * a resource adapter implementation-specific way. It must use
     * javax.resource.spi.ManagedConnection instance as its underlying physical
     * connection.
     */
    ...
    public Query createSQLQuery(String string, String returnAlias,
            Class returnClass) {
        return getSession().createSQLQuery(string, returnAlias, returnClass);
    }

    public Query createSQLQuery(String string, String returnAliases[],
            Class returnClasses[]) {
        return getSession()
                .createSQLQuery(string, returnAliases, returnClasses);
    }
