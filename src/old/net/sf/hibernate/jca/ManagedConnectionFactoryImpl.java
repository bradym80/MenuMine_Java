...
public class ManagedConnectionFactoryImpl implements ManagedConnectionFactory,
     ...
     *             can't create Session Factory (thrown with linked exception)
     */
    public Object createConnectionFactory(final ConnectionManager cxManager)
        ...
        try {
            ...
            final String message = "Got Hibernate exception when trying to create "
                    + "Connection Factory";
            log(message, hbe);
     ...
     * session factory. This method is synchonized, because a container does not
     * have to serialize createConnectionFactory/createManagedConnection calls.
     */
    private synchronized void initialize() throws ResourceException {
        ...
        if (datasource == null) {
            try {
                ...
                final String message = "Cannot locate DataSource "
                        + datasourceJndi;
                log(message, e);
                final ResourceException re = new ResourceException(message);
        ...
        if (sessionFactory == null) {
            try {
                ...
                String[] mappingFiles = PropertiesHelper.toStringArray(
                        mapResources, delim);
                ...
                final String message = "Cannot create Hibernate session factory";
                log(message, e);
                final ResourceException re = new ResourceException(message);
                re.setLinkedException(e);
                throw re;
    ...
    /**
     * JCA 1.0, 5.5.3 It is required that the ManagedConnectionFactory
     * implementation class extend the implementation of the hashCode and equals
     * methods defined in the java.lang.Object class.
     * 
    ...
    public int hashCode() {
        int result = 17;
        result = result * 37
                + ((datasourceJndi == null) ? 0 : datasourceJndi.hashCode());
        result = result * 37 + ((dialect == null) ? 0 : dialect.hashCode());
        result = result * 37
                + ((mapResources == null) ? 0 : mapResources.hashCode());
        result = result * 37
    ...
    public boolean equals(final Object object) {
        ...
        if (object instanceof ManagedConnectionFactoryImpl) {
            final ManagedConnectionFactoryImpl other = (ManagedConnectionFactoryImpl) object;
