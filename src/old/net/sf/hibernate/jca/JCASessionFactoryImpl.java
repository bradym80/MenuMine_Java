// $Id: JCASessionFactoryImpl.java,v 1.2 2005/04/03 06:29:05 nick Exp $
...
public final class JCASessionFactoryImpl implements SessionFactory,
        Referenceable {
    ...
    public JCASessionFactoryImpl(
            ...
            final ConnectionManager cxManager) throws HibernateException {
    ...
    public Session openSession() throws HibernateException {
        ...
        try {
            ...
            result = (Session) cxManager.allocateConnection(managedFactory,
                    null);
