// $Id: JDBCExceptionReporter.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public final class JDBCExceptionReporter {
    ...
    private static final Log log = LogFactory
            .getLog(JDBCExceptionReporter.class);
    ...
    public static void logWarnings(SQLWarning warning) {
        if (log.isWarnEnabled()) {
            ...
            while (warning != null) {
                log.warn(new StringBuffer(30).append("SQL Warning: ").append(
                        warning.getErrorCode()).append(", SQLState: ").append(
                        warning.getSQLState()).toString());
