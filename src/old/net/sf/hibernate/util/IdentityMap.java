//$Id: IdentityMap.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public final class IdentityMap implements Map {
    ...
    /**
     * Return a new instance of this class, with iteration order defined by the
     * order that entries were added
     */
     ...
     * add new instances to the underlying <tt>Map</tt> during iteration of
     * the <tt>entries()</tt>.
     * 
     * @param map
     * @return Collection
    ...
    public Set entrySet() {
        ...
        while (iter.hasNext()) {
            Map.Entry me = (Map.Entry) iter.next();
            set.add(new IdentityMapEntry(((IdentityKey) me.getKey()).key, me
                    .getValue()));
        }
        return set;
    }
    ...
    public List entryList() {
        ...
        while (iter.hasNext()) {
            Map.Entry me = (Map.Entry) iter.next();
            list.add(new IdentityMapEntry(((IdentityKey) me.getKey()).key, me
                    .getValue()));
        }
        return list;
    }
