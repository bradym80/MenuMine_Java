//$Id: LogicalExpression.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public abstract class LogicalExpression extends AbstractCriterion {
    ...
    public TypedValue[] getTypedValues(
        ...
        TypedValue[] lhstv = lhs.getTypedValues(sessionFactory,
                persistentClass, aliasClasses);
        TypedValue[] rhstv = rhs.getTypedValues(sessionFactory,
                persistentClass, aliasClasses);
