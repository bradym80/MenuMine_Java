//$Id: AbstractCriterion.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public abstract class AbstractCriterion implements Criterion {
    ...
    protected static String[] getColumns(
            ...
            String property, String alias, Map aliasClasses)
        ...
        return ((Queryable) sessionFactory.getPersister(persistentClass))
                .toColumns(alias, property);
    }

    protected static TypedValue getTypedValue(
            SessionFactoryImplementor sessionFactory, Class persistentClass,
            String propertyName, Object value, Map aliasClasses)
            throws HibernateException {
        ...
        return new TypedValue(((Queryable) sessionFactory
                .getPersister(persistentClass)).toType(propertyName), value);
    }
