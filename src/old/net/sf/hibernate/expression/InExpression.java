//$Id: InExpression.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class InExpression extends AbstractCriterion {
    ...
    public String toSqlString(SessionFactoryImplementor sessionFactory,
        ...
        return StringHelper.join(" and ", StringHelper.suffix(getColumns(
                sessionFactory, persistentClass, propertyName, alias,
                aliasClasses), condition));
    ...
    public TypedValue[] getTypedValues(
        ...
        for (int i = 0; i < tvs.length; i++) {
            tvs[i] = getTypedValue(sessionFactory, persistentClass,
                    propertyName, values[i], aliasClasses);
        }
        return tvs;
    }
