//$Id: PropertyAccessorFactory.java,v 1.2 2005/04/03 06:29:05 nick Exp $
    ...
    public static PropertyAccessor getPropertyAccessor(String type)
        ...
        try {
            ...
            throw new MappingException(
                    "could not find PropertyAccessor class: " + type, cnfe);
        }
        try {
            return (PropertyAccessor) accessorClass.newInstance();
        } catch (Exception e) {
            throw new MappingException(
                    "could not instantiate PropertyAccessor class: " + type, e);
        }
