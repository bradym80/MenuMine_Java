//$Id: DirectPropertyAccessor.java,v 1.2 2005/04/03 06:29:05 nick Exp $
...
public class DirectPropertyAccessor implements PropertyAccessor {
        ...
        public Object get(Object target) throws HibernateException {
            try {
                ...
                throw new PropertyAccessException(e,
                        "could not get a field value by reflection", false,
                        clazz, name);
            }
        }
    ...
    public static final class DirectSetter implements Setter {
        ...
        public void set(Object target, Object value) throws HibernateException {
            try {
                ...
                throw new PropertyAccessException(e,
                        "could not set a field value by reflection", true,
                        clazz, name);
            }
        }
    ...
    public Getter getGetter(Class theClass, String propertyName)
            throws PropertyNotFoundException {
        return new DirectGetter(getField(theClass, propertyName), theClass,
                propertyName);
    }

    public Setter getSetter(Class theClass, String propertyName)
            throws PropertyNotFoundException {
        return new DirectSetter(getField(theClass, propertyName), theClass,
                propertyName);
    }
