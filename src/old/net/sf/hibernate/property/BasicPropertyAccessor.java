//$Id: BasicPropertyAccessor.java,v 1.3 2005/04/03 06:29:05 nick Exp $
...
public class BasicPropertyAccessor implements PropertyAccessor {
    ...
    private static final Log log = LogFactory
            .getLog(BasicPropertyAccessor.class);
        ...
        public void set(Object target, Object value) throws HibernateException {
            try {
                ...
                throw new PropertyAccessException(ite,
                        "Exception occurred inside", true, clazz, propertyName);
            } catch (IllegalAccessException iae) {
                throw new PropertyAccessException(iae,
                        "IllegalAccessException occurred while calling", true,
                        clazz, propertyName);
                //cannot occur
                ...
                if (value == null
                    ...
                    log.error("IllegalArgumentException in class: "
                            + clazz.getName() + ", setter method of property: "
                            + propertyName);
    ...
    public static final class BasicGetter implements Getter {
        ...
        public Object get(Object target) throws HibernateException {
            try {
                ...
                throw new PropertyAccessException(ite,
                        "Exception occurred inside", false, clazz, propertyName);
            } catch (IllegalAccessException iae) {
                throw new PropertyAccessException(iae,
    ...
    public Setter getSetter(Class theClass, String propertyName)
        ...
        if (result == null)
            throw new PropertyNotFoundException(
                    "Could not find a setter for property " + propertyName
                            + " in class " + theClass.getName());
        return result;
    }

    private static BasicSetter getSetterOrNull(Class theClass,
            String propertyName) {
        ...
        if (method != null) {
            ...
            BasicSetter setter = getSetterOrNull(theClass.getSuperclass(),
                    propertyName);
            if (setter == null) {
    ...
    public Getter getGetter(Class theClass, String propertyName)
        ...
        if (result == null)
            throw new PropertyNotFoundException("Could not find a getter for "
                    + propertyName + " in class " + theClass.getName());
        return result;

    }

    private static BasicGetter getGetterOrNull(Class theClass,
            String propertyName) {
        ...
        if (method != null) {
            ...
            BasicGetter getter = getGetterOrNull(theClass.getSuperclass(),
                    propertyName);
            if (getter == null) {
                Class[] interfaces = theClass.getInterfaces();
