//$Id: SimpleValue.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class SimpleValue implements Value {
    ...
    public IdentifierGenerator createIdentifierGenerator(Dialect dialect)
        ...
        if (uniqueIdentifierGenerator == null) {
            uniqueIdentifierGenerator = IdentifierGeneratorFactory.create(
                    identifierGeneratorStrategy, type,
                    identifierGeneratorProperties, dialect);
        }
     ...
     * 
     * @param identifierGeneratorProperties
     *            The identifierGeneratorProperties to set
     */
    public void setIdentifierGeneratorProperties(
     ...
     * 
     * @param identifierGeneratorStrategy
     *            The identifierGeneratorStrategy to set
     */
    public void setIdentifierGeneratorStrategy(
    ...
    public void setTypeByReflection(Class propertyClass, String propertyName)
        ...
        try {
            if (type == null) {
                type = ReflectHelper.reflectedPropertyType(propertyClass,
                        propertyName);
                Iterator iter = getColumnIterator();
                int count = 0;
                while (iter.hasNext()) {
            ...
            throw new MappingException(
                    "Problem trying to set property type by reflection", he);
        }
    }
