//$Id: Property.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class Property {
    ...
    public Cascades.CascadeStyle getCascadeStyle() throws MappingException {
        ...
        if (type.isComponentType() && !type.isObjectType()) {
            ...
            /*
             * else if ( cascade.equals("save") ) { return Cascades.STYLE_SAVE; }
             */
                ...
                throw new MappingException("Unsupported cascade style: "
                        + cascade);
            }
        }
    }
    ...
    public Getter getGetter(Class clazz) throws PropertyNotFoundException,
            MappingException {
        return getPropertyAccessor().getGetter(clazz, name);
    }

    public Setter getSetter(Class clazz) throws PropertyNotFoundException,
            MappingException {
    ...
    protected PropertyAccessor getPropertyAccessor() throws MappingException {
        return PropertyAccessorFactory
                .getPropertyAccessor(getPropertyAccessorName());
    }

    public boolean isBasicPropertyAccessor() {
        return propertyAccessorName == null
                || "property".equals(propertyAccessorName);
    }
