//$Id: OneToOne.java,v 1.3 2005/04/03 06:29:03 nick Exp $
...
public class OneToOne extends ToOne {
    ...
    public void setTypeByReflection(Class propertyClass, String propertyName)
        ...
        try {
            if (getType() == null)
                setType(TypeFactory.oneToOne(ReflectHelper
                        .reflectedPropertyClass(propertyClass, propertyName),
                        foreignKeyType, referencedPropertyName));
    ...
    public void createForeignKey() {
        if (constrained && referencedPropertyName == null) {
            //TODO: handle the case of a foreign key to something other than
            // the pk
