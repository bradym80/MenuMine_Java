//$Id: PersistentClass.java,v 1.3 2005/04/03 06:29:03 nick Exp $
...
public abstract class PersistentClass {
    ...
    public void addNewProperty(Property prop) throws MappingException {
        ...
        if (old != null) {
            throw new MappingException("duplicate mapping for property: "
                    + getName() + StringHelper.DOT + prop.getName());
        }
    }
    ...
    public Iterator getSubclassPropertyClosureIterator() {
        return new JoinedIterator(getPropertyClosureIterator(),
                subclassProperties.iterator());
    }

    public Iterator getSubclassTableClosureIterator() {
        return new JoinedIterator(getTableClosureIterator(), subclassTables
                .iterator());
    }
            ...
            if (!prop.isValid(mapping)) {
                throw new MappingException(
                        "property mapping has wrong number of columns: "
                                + StringHelper.qualify(getMappedClass()
                                        .getName(), prop.getName()) + " type: "
