//$Id: Collection.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
/**
 * Mapping for a collection. Subclasses specialize to particular collection
 * styles.
 * 
 * @author Gavin King
 */
public abstract class Collection implements Fetchable, Value {
    ...
    private void createForeignKeys() {
        if (!isInverse()) { // for inverse collections, let the "other end"
            // handle it
