//$Id: Set.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
/**
 * A set with no nullable element columns. It will have a primary key consisting
 * of all table columns (ie. key columns + element columns).
 * 
 * @author Gavin King
 */
public class Set extends Collection {
    ...
    public PersistentCollectionType getCollectionType() {
        return isSorted() ? TypeFactory.sortedSet(getRole(), getComparator())
