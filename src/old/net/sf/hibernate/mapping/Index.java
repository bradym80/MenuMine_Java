//$Id: Index.java,v 1.3 2005/04/03 06:29:03 nick Exp $
...
public class Index implements RelationalModel {
    ...
    public String sqlCreateString(Dialect dialect, Mapping mapping)
        ...
        StringBuffer buf = new StringBuffer("create index ").append(
                dialect.qualifyIndexName() ? name : StringHelper
                        .unqualify(name)).append(" on ").append(
                table.getQualifiedName(dialect)).append(" (");
    ...
    public String sqlDropString(Dialect dialect) {
        return "drop index "
                + StringHelper.qualify(table.getQualifiedName(dialect), name);
    }
