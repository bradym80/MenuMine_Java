//$Id: Subclass.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
/**
 * A sublass in a table-per-subclass, or table-per-concrete-class inheritance
 * hierarchy.
 * 
 * @author Gavin King
 */
public class Subclass extends PersistentClass {
    ...
    public Iterator getPropertyClosureIterator() {
        return new JoinedIterator(new Iterator[] { getPropertyIterator(),
