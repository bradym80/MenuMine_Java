//$Id: IndexedCollection.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
public abstract class IndexedCollection extends Collection {
    ...
    void createPrimaryKey() {
        if (!isOneToMany()) {
            ...
            pk.addColumns(getIndex().getColumnIterator()); // index should be
            // last column listed
            ...
            // columns
            /*
             * ArrayList list = new ArrayList(); list.addAll(
             * getKey().getConstraintColumns() ); list.addAll(
             * getIndex().getConstraintColumns() );
