//$Id: SessionFactoryImplementor.java,v 1.3 2005/04/03 06:29:04 nick Exp $
...
/**
 * Defines the internal contract between the <tt>SessionFactory</tt> and other
 * parts of Hibernate such as implementors of <tt>Type</tt>.
 * 
...
public interface SessionFactoryImplementor extends Mapping, SessionFactory {
    ...
    /**
     * Get the names of all persistent classes that implement/extend the given
     * interface/class
     */
     ...
     * 
     * @param regionName
     *            the name of the cache region, or null for the default query
     *            cache
     * @return the existing cache, or a newly created cache if none by that
     *         region name
     */
