//$Id: TransactionalCache.java,v 1.2 2005/04/03 06:29:04 nick Exp $
 ...
 * Note that this might be a less scalable concurrency strategy than
 * <tt>ReadWriteCache</tt>. This is a "synchronous" concurrency strategy.
 * 
 * @author Gavin King
 */
public class TransactionalCache implements CacheConcurrencyStrategy {
     ...
     * Do nothing.
     */
    public void afterUpdate(Object key, Object value, SoftLock clientLock)
            throws CacheException {
        // noop
    }
