//$Id: CacheFactory.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public final class CacheFactory {
    ...
    public static CacheConcurrencyStrategy createCache(Element node,
            String name, boolean mutable) throws MappingException {
        return createCache(node.attributeValue("usage"), name, mutable);
    }

    private static CacheConcurrencyStrategy createCache(String usage,
            String name, boolean mutable) throws MappingException {
