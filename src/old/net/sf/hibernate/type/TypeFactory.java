//$Id: TypeFactory.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public final class TypeFactory {
     ...
     */
    public static Type oneToOne(Class persistentClass,
            ForeignKeyDirection foreignKeyType, String uniqueKeyPropertyName) {
    ...
    /**
     * Uses heuristics to deduce a Hibernate type given a string naming the type
     * or Java class. Return an instance of <tt>net.sf.hibernate.type.Type</tt>.
     */
     ...
     */
    public static void deepCopy(Object[] values, Type[] types, boolean[] copy,
    ...
    /**
     * Determine if any of the given field values are dirty, returning an array
     * containing indexes of the dirty fields or <tt>null</tt> if no fields
     * are dirty.
     */
    public static int[] findDirty(Type[] types, Object[] x, Object[] y,
            boolean[] check, SessionImplementor session)
    ...
    /**
     * Determine if any of the given field values are modified, returning an
     * array containing indexes of the dirty fields or <tt>null</tt> if no
     * fields are dirty.
     */
    public static int[] findModified(Type[] types, Object[] old,
            Object[] current, boolean[] check, SessionImplementor session)
            throws HibernateException {
        int[] results = null;
        int count = 0;
        for (int i = 0; i < types.length; i++) {
    ...
    public static Object[] assemble(Serializable[] row, Type[] types,
    ...
    public static Serializable[] disassemble(Object[] row, Type[] types,
    ...
    public static Object[] copy(Object[] original, Object[] target,
            Type[] types, SessionImplementor session, Object owner)
            throws HibernateException {
    ...
    /**
     * Return <tt>-1</tt> if non-dirty, or the index of the first dirty value
     * otherwise
     */
    /*
     * public static int findDirty(Type[] types, Object[] x, Object[] y, Object
     * owner, SessionFactoryImplementor factory) throws HibernateException { for
     * (int i=0; i <types.length; i++) { if ( types[i].isDirty( x[i], y[i],
     * owner, factory ) ) { return i; } } return -1; }
     */
