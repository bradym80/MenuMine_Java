//$Id: SerializableType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
/**
 * <tt>serializable</tt>: A type that maps an SQL VARBINARY to a serializable
 * Java object.
 * 
 * @author Gavin King
 */
public class SerializableType extends MutableType {
    ...
    public String getName() {
        return (serializableClass == Serializable.class) ? "serializable"
    ...
    public boolean equals(Object object) {
        return super.equals(object) ? ((SerializableType) object).serializableClass == serializableClass
                : false;
    }
