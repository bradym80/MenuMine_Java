//$Id: CurrencyType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class CurrencyType extends ImmutableType implements LiteralType {
    ...
    public Object get(ResultSet rs, String name) throws HibernateException,
        ...
        try {
            return (code == null) ? null : CURRENCY_GET_INSTANCE.invoke(null,
                    new Object[] { code });
        } catch (Exception e) {
            throw new HibernateException("Could not resolve currency code: "
                    + code);
        }
    }

    /**
     * @see net.sf.hibernate.type.NullableType#set(PreparedStatement, Object,
     *      int)
     */
