//$Id: ArrayType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class ArrayType extends PersistentCollectionType {
    ...
    public Serializable disassemble(Object value, SessionImplementor session)
        ...
        if (value == null) {
            ...
            return session
                    .getLoadedCollectionKey(session.getArrayHolder(value));
        }
    }
    ...
    public Object copy(Object original, Object target,
        ...
        for (int i = 0; i < length; i++) {
            Array.set(result, i, elemType.copy(Array.get(original, i), null,
                    session, owner));
        }
        return result;
    }
