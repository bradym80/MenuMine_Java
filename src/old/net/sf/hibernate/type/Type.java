//$Id: Type.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
/**
 * Defines a mapping from a Java type to an JDBC datatype. This interface is
 * intended to be implemented by applications that need custom types. <br>
 * <br>
 * Implementors should usually be immutable and <b>must </b> certainly be
 * threadsafe. Implementors must override <tt>equals()</tt>.
 * 
 * @author Gavin King
 */
public interface Type extends Serializable {
    ...
    /**
     * Return true if the implementation is castable to <tt>AssociationType</tt>.
     * This does not necessarily imply that the type actually represents an
     * association.
     * 
     * @see AssociationType
     * @return boolean
     ...
     * to <tt>AbstractComponentType</tt>. A component type may own
     * collections or associations and hence must provide certain extra
     * functionality.
     * 
     ...
     * 
     * I.e. a reference to a persistent entity that is not modelled as a
    ...
    /**
     * Has the parent object been modified, compared to the current database
     * state?
     * 
     * @param oldHydratedState
     *            the database state, in a "hydrated" form, with identifiers
     *            unresolved
     * @param currentState
    ...
    /**
     * Retrieve an instance of the mapped class from a JDBC resultset.
     * Implementations should handle possibility of null values. This method
     * might be called if the type is known to be a single-column type.
     * 
     * @param rs
     * @param name
     *            the column name
    ...
    /**
     * Does this type implement a well-behaved <tt>equals()</tt> method. (ie.
     * one that is consistent with <tt>Type.equals()</tt>.) Strictly, if this
     * method returns <tt>true</tt> then <tt>x.equals(y)</tt> implies
     * <tt>Type.equals(x, y)</tt> and also <tt>Type.equals(x, y)</tt>
     * implies that <b>probably </b> <tt>x.equals(y)</tt>
     * 
    ...
    /**
     * Retrieve an instance of the mapped class, or the identifier of an entity
     * or collection, from a JDBC resultset. This is useful for 2-phase property
     * initialization - the second phase is a call to
    ...
    /**
     * Map identifiers to entities or collections. This is the second phase of
     * 2-phase property initialization.
     * 
     * @see Type#hydrate(ResultSet, String[], SessionImplementor, Object)
     * @param value
