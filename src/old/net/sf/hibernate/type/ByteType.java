//$Id: ByteType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
 ...
 * @author Gavin King
 */
public class ByteType extends PrimitiveType implements DiscriminatorType,
        VersionType {
    ...
    public void set(PreparedStatement st, Object value, int index)
            throws SQLException {
        st.setInt(index, ((Byte) value).byteValue());
    }
