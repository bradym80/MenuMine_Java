//$Id: TimeType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
/**
 * <tt>time</tt>: A type that maps an SQL TIME to a Java java.util.Date or
 * java.sql.Time.
 * 
 * @author Gavin King
 */
    ...
    public boolean equals(Object x, Object y) {
        ...
        return calendar1.get(Calendar.HOUR_OF_DAY) == calendar2
                ...
                && calendar1.get(Calendar.SECOND) == calendar2
                        .get(Calendar.SECOND)
                && calendar1.get(Calendar.MILLISECOND) == calendar2
