//$Id: OneToOneType.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
public class OneToOneType extends EntityType {
    ...
    public OneToOneType(Class persistentClass,
    ...
    protected Object resolveIdentifier(Serializable id,
        ...
        return isNullable() ? session.internalLoadOneToOne(clazz, id) : //no
                // proxy
                // allowed
