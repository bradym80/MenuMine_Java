//$Id: PersistentEnumType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class PersistentEnumType extends ImmutableType implements LiteralType {
    ...
    public Object getInstance(Integer code) throws HibernateException {
        try {
            ...
            throw new AssertionFailure(
                    "Could not invoke fromInt() from PersistentEnumType", iae);
        } catch (InvocationTargetException ite) {
            throw new HibernateException(
                    "InvocationTargetException occurred inside fromInt()", ite);
        } catch (IllegalAccessException iae) {
            throw new HibernateException(
                    "IllegalAccessException occurred calling fromInt()", iae);
        }
    }

    public boolean equals(Object x, Object y) {
        return (x == y)
                || (x != null && y != null && x.getClass() == y.getClass() && ((PersistentEnum) x)
                        .toInt() == ((PersistentEnum) y).toInt());
    }
    ...
    public Serializable disassemble(Object value, SessionImplementor session)
        ...
        return (value == null) ? null : new Integer(((PersistentEnum) value)
                .toInt());
    }
