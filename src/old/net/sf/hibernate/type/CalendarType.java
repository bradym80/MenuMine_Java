//$Id: CalendarType.java,v 1.2 2005/04/03 06:29:03 nick Exp $
...
public class CalendarType extends MutableType implements VersionType {
    ...
    public void set(PreparedStatement st, Object value, int index)
        ...
        st.setTimestamp(index, new Timestamp(((Calendar) value).getTime()
                .getTime()));
    }
    ...
    public boolean equals(Object x, Object y) throws HibernateException {
        ...
        return calendar1.get(Calendar.MILLISECOND) == calendar2
