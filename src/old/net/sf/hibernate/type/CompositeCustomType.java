//$Id: CompositeCustomType.java,v 1.3 2005/04/03 06:29:03 nick Exp $
 ...
 * @author Gavin King
 */
public class CompositeCustomType extends AbstractType implements
    ...
    public CompositeCustomType(Class userTypeClass) throws MappingException {
        ...
        try {
            ...
            throw new MappingException("Cannot instantiate custom type: "
            ...
            throw new MappingException(userTypeClass.getName()
                    + " must implement net.sf.hibernate.UserType");
        }

        if (!Serializable.class.isAssignableFrom(userType.returnedClass())) {
            LogFactory.getLog(CustomType.class).warn(
                    "custom type does not implement Serializable: "
                            + userTypeClass);
        }
    }
    ...
    public Object nullSafeGet(ResultSet rs, String columnName,
            SessionImplementor session, Object owner)
            throws HibernateException, SQLException {

        return userType.nullSafeGet(rs, new String[] { columnName }, session,
                owner);
    }
    ...
    public boolean equals(Object object) {
        if (!super.equals(object))
            return false;
        return ((CompositeCustomType) object).userType.getClass() == userType
                .getClass();
    }
