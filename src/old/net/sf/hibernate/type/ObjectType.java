//$Id: ObjectType.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
public class ObjectType extends AbstractType implements AbstractComponentType,
    ...
    /**
     * @see net.sf.hibernate.type.Type#nullSafeGet(ResultSet, String,
    ...
    public Object nullSafeGet(ResultSet rs, String[] names,
            SessionImplementor session, Object owner)
            throws HibernateException, SQLException {
        return resolve((Class) metaType.nullSafeGet(rs, names[0], session,
                owner), (Serializable) identifierType.nullSafeGet(rs, names[1],
    ...
    public Object hydrate(ResultSet rs, String[] names,
            SessionImplementor session, Object owner)
            throws HibernateException, SQLException {
        Class clazz = (Class) metaType
                .nullSafeGet(rs, names[0], session, owner);
        Serializable id = (Serializable) identifierType.nullSafeGet(rs,
                names[1], session, owner);
    ...
    private Object resolve(Class clazz, Serializable id,
            SessionImplementor session) throws HibernateException {
        return (clazz == null || id == null) ? null : session.internalLoad(
                clazz, id);
    }

    /**
     * @see net.sf.hibernate.type.Type#nullSafeSet(PreparedStatement, Object,
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index,
        ...
        identifierType.nullSafeSet(st, id, index + 1, session); // metaType must
        // be
        // single-column
        // type
    }
    ...
    public int[] sqlTypes(Mapping mapping) throws MappingException {
        return ArrayHelper.join(metaType.sqlTypes(mapping), identifierType
                .sqlTypes(mapping));
    }
    ...
    public String toString(Object value, SessionFactoryImplementor factory)
        ...
        return value == null ? "null" : Hibernate.entity(
                HibernateProxyHelper.getClass(value)).toString(value, factory);
    }
    ...
    /**
     * @see net.sf.hibernate.type.Type#assemble(Serializable,
     *      SessionImplementor, Object)
     */
    ...
    public Serializable disassemble(Object value, SessionImplementor session)
        ...
        return (value == null) ? null : new ObjectTypeCacheEntry(
                HibernateProxyHelper.getClass(value), session
    ...
    public Object getPropertyValue(Object component, int i,
        ...
        return (i == 0) ? HibernateProxyHelper.getClass(component) : id(
                component, session);
    }
    ...
    public Object[] getPropertyValues(Object component,
        ...
        return new Object[] { HibernateProxyHelper.getClass(component),
                id(component, session) };
    }

    private Serializable id(Object component, SessionImplementor session)
            throws HibernateException {
        try {
    ...
    public String[] getReferencedColumns(SessionFactoryImplementor factory)
        ...
        throw new UnsupportedOperationException(
                "any types do not have unique referenced columns");
    }
    ...
    public boolean isModified(Object old, Object current,
        ...
        return holder.clazz != HibernateProxyHelper.getClass(current)
                || identifierType.isModified(holder.id, id(current, session),
                        session);
    }
