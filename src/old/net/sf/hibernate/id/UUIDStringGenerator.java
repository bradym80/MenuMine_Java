//$Id: UUIDStringGenerator.java,v 1.2 2005/04/03 06:29:04 nick Exp $
 ...
 * <b>uuid.string </b> <br>
 * <br>
 * A <tt>UUIDGenerator</tt> that returns a string of length 16, This string
 * will NOT consist of only alphanumeric characters. Use this only if you don't
 * mind unreadable identifiers. <br>
 * <br>
...
public class UUIDStringGenerator extends UUIDGenerator implements Configurable {
    ...
    public Serializable generate(SessionImplementor cache, Object obj) {
        return new StringBuffer(20).append(toString(getIP())).append(sep)
                .append(toString(getJVM())).append(sep).append(
                        toString(getHiTime())).append(sep).append(
                        toString(getLoTime())).append(sep).append(
                        toString(getCount())).toString();
    }
