//$Id: IdentifierGeneratorFactory.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public final class IdentifierGeneratorFactory {
    ...
    // LogFactory.getLog(IdentifierGeneratorFactory.class);
    ...
    public static IdentifierGenerator create(String strategy, Type type,
            Properties params, Dialect dialect) throws MappingException {
        try {
            //if ( "vm".equals(strategy) ) log.info("'vm' strategy is
            ...
            IdentifierGenerator idgen = (IdentifierGenerator) clazz
                    .newInstance();
