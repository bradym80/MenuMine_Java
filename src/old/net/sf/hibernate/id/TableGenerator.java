//$Id: TableGenerator.java,v 1.3 2005/04/03 06:29:04 nick Exp $
...
/**
 * An <tt>IdentifierGenerator</tt> that uses a database table to store the
 * last generated value. It is not intended that applications use this strategy
 * directly. However, it may be used to build other (efficient) strategies. The
 * returned type is <tt>Integer</tt>.<br>
 * <br>
 * The hi value MUST be fetched in a seperate transaction to the
 * <tt>Session</tt> transaction so the generator must be able to obtain a new
 * connection and commit it. Hence this implementation may not be used when
 * Hibernate is fetching connections from an application server datasource or
 * when the user is supplying connections. <br>
 * <br>
...
public class TableGenerator implements PersistentIdentifierGenerator,
    ...
    public synchronized Serializable generate(SessionImplementor session,
            Object object) throws SQLException, HibernateException {
        ...
        try {
            ...
            do {
                ...
                try {
                    ...
                    log.error("could not update hi value in: " + tableName,
                            sqle);
                    throw sqle;
                } finally {
                    ups.close();
