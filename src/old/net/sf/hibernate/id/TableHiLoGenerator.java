//$Id: TableHiLoGenerator.java,v 1.2 2005/04/03 06:29:04 nick Exp $
 ...
 * implementation may not be used when Hibernate is fetching connections from an
 * application server datasource or when the user is supplying connections. In
 * these cases a <tt>SequenceHiLoGenerator</tt> would be a better choice
 * (where supported). <br>
 * <br>
