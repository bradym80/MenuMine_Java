 ...
 * <b>foreign </b> <br>
 * <br>
 * An <tt>Identifier</tt> generator that uses the value of the id property of
 * an associated object <br>
 * <br>
...
public class ForeignGenerator implements IdentifierGenerator, Configurable {
    ...
    public Serializable generate(SessionImplementor session, Object object)
        ...
        Object associatedObject = session.getFactory().getClassMetadata(
                object.getClass()).getPropertyValue(object, propertyName);
        ...
        if (session.contains(object)) {
            ...
            //throw new IdentifierGenerationException("save associated object
            // first, or disable cascade for inverse association");
        }
        return id;
    }
