//$Id: FilterImpl.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public class FilterImpl extends QueryImpl {
    ...
    public FilterImpl(String queryString, Object collection,
    ...
    public Iterator iterate() throws HibernateException {
        ...
        return getSession().iterateFilter(collection,
    ...
    public List list() throws HibernateException {
        verifyParameters();
        Map namedParams = getNamedParams();
        return getSession().filter(collection, bindParameterLists(namedParams),
                getQueryParameters(namedParams));
    }
