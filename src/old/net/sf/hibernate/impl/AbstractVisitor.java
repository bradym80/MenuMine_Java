//$Id: AbstractVisitor.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
/**
 * Abstract superclass of algorithms that walk a tree of property values of an
 * entity, and perform specific functionality for collections, components and
 * associated entities.
 * 
 * @author Gavin King
 */
abstract class AbstractVisitor {
    ...
    /**
     * Visit a property value. Dispatch to the correct handler for the property
     * type.
     * 
     * @param value
     * @param type
    ...
    void process(Object object, ClassPersister persister)
            throws HibernateException {
        processValues(persister.getPropertyValues(object), persister
                .getPropertyTypes());
    }
    ...
    /**
     * Visit a many-to-one or one-to-one associated entity. Default superclass
