//$Id: BatchingBatcher.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
/**
 * An implementation of the <tt>Batcher</tt> interface that actually uses
 * batching
 * 
 * @author Gavin King
 */
public class BatchingBatcher extends BatcherImpl {
    ...
    public void addToBatch(int expectedRowCount) throws SQLException,
        ...
        if (batchSize == getFactory().getJdbcBatchSize()) {
            ...
            /*
             * } catch (SQLException sqle) { closeStatement(batchUpdate); throw
             * sqle; } catch (HibernateException he) {
             * closeStatement(batchUpdate); throw he; }
             */
        }
                    ...
                    if (results[i] == -2) {
                        ...
                        if (expectedRowCounts[i] >= 0
                            ...
                            throw new HibernateException(
                                    "Batch update row count wrong: " + i);
                        }
                    }
                }
            }
