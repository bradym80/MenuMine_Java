//$Id: Printer.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
public final class Printer {
    ...
    public String toString(Object entity) throws HibernateException {
        ...
        if (cm.hasIdentifierProperty()) {
            result.put(cm.getIdentifierPropertyName(), cm.getIdentifierType()
                    .toString(cm.getIdentifier(entity), factory));
        }
    ...
    public String toString(Type[] types, Object[] values)
            throws HibernateException {
        List list = new ArrayList(types.length * 5);
        for (int i = 0; i < types.length; i++) {
            if (types[i] != null)
                list.add(types[i].toString(values[i], factory));
        }
    ...
    public String toString(Map namedTypedValues) throws HibernateException {
        ...
        while (iter.hasNext()) {
            ...
            result.put(me.getKey(), tv.getType().toString(tv.getValue(),
                    factory));
        }
