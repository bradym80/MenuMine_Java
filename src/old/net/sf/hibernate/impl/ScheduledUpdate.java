// $Id: ScheduledUpdate.java,v 1.2 2005/04/03 06:29:04 nick Exp $
...
final class ScheduledUpdate extends ScheduledEntityAction implements
    ...
    public ScheduledUpdate(Serializable id, Object[] fields,
            int[] dirtyProperties, Object[] oldFields, Object lastVersion,
            Object nextVersion, Object instance, Object[] updatedState,
    ...
    public void execute() throws HibernateException {
        ...
        persister.update(id, fields, dirtyFields, oldFields, lastVersion,
                instance, session);
        ...
        if (persister.hasCache()) {
            if (persister.isCacheInvalidationRequired()) {
                ...
                //TODO: inefficient if that cache is just going to ignore the
                // updated state!
