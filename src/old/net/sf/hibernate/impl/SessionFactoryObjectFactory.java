//$Id: SessionFactoryObjectFactory.java,v 1.3 2005/08/24 04:33:25 nick Exp $
...
public class SessionFactoryObjectFactory implements ObjectFactory {
    ...
    private static final SessionFactoryObjectFactory INSTANCE; //to stop the
    ...
    private static final NamingListener LISTENER = new NamespaceChangeListener() {
        ...
        public void objectRenamed(NamingEvent evt) {
            ...
            NAMED_INSTANCES.put(evt.getNewBinding().getName(), NAMED_INSTANCES
                    .remove(name));
        }
    ...
    public static void addInstance(String uid, String name,
            SessionFactory instance, Properties properties) {

        log.debug("registered: " + uid + " ("
