//$Id: OnReplicateVisitor.java,v 1.2 2005/04/03 06:29:04 nick Exp $
 ...
 * 1. associate any uninitialized PersistentCollections with this session 2.
 * associate any initialized PersistentCollections with this session, using the
 * existing snapshot 3. execute a collection removal (SQL DELETE) for each null
 * collection property or "new" collection
 * 
 * @author Gavin King
 */
class OnReplicateVisitor extends ReattachVisitor {
    ...
    Object processCollection(Object collection, PersistentCollectionType type)
        ...
        CollectionPersister persister = session.getCollectionPersister(type
                .getRole());
