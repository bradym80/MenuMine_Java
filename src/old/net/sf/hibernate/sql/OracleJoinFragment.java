//$Id: OracleJoinFragment.java,v 1.2 2005/04/03 06:29:05 nick Exp $
    ...
    public void addJoin(String tableName, String alias, String[] fkColumns,
        ...
        for (int j = 0; j < fkColumns.length; j++) {
            ...
            if (joinType == RIGHT_OUTER_JOIN || joinType == FULL_JOIN)
                afterWhere.append("(+)");
            afterWhere.append('=').append(alias).append(StringHelper.DOT)
                    .append(pkColumns[j]);
            if (joinType == LEFT_OUTER_JOIN || joinType == FULL_JOIN)
                afterWhere.append("(+)");
        }
