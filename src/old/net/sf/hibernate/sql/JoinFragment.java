//$Id: JoinFragment.java,v 1.2 2005/04/03 06:29:05 nick Exp $
...
public abstract class JoinFragment {
    ...
    public abstract void addJoin(String tableName, String alias,
    ...
    public abstract void addCondition(String alias, String[] columns,
            String condition);

    public abstract void addCondition(String alias, String[] fkColumns,
            String[] pkColumns);
