//$Id: SelectFragment.java,v 1.3 2005/08/24 04:33:28 nick Exp $
...
public class SelectFragment {
    ...
    public SelectFragment addFormulas(String tableAlias, String[] formulas,
    ...
    public SelectFragment addFormula(String tableAlias, String formula,
            String formulaAlias) {
        columns.add(StringHelper
                .replace(formula, Template.TEMPLATE, tableAlias));
    ...
    public String toFragmentString() {
        ...
        while (iter.hasNext()) {
            ...
            String qualifiedColumn = column; //alias==null ? column : alias +
            // StringHelper.DOT + column;
            ...
            /*
             * if ( !( columnAlias.equals(otherAlias) ) ) { throw new
             * AssertionFailure("bug in Hibernate SQL alias generation"); }
             */
            if (columnAlias.equals(otherAlias)) {
            } else {
                buf.append(StringHelper.COMMA_SPACE).append(qualifiedColumn)
                        .append(" as ").append(
                                new Alias(suffix).toAliasString(columnAlias));
            }
        }
        return buf.toString();
    }
