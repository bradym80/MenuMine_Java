//$Id: InFragment.java,v 1.2 2005/04/03 06:29:05 nick Exp $
...
public class InFragment {
    ...
    public String toFragmentString() {
        ...
        if (values.size() > 1) {
            ...
            if (allowNull)
                buf.insert(0, " is null or ").insert(0, columnName).insert(0,
                        StringHelper.OPEN_PAREN).append(
